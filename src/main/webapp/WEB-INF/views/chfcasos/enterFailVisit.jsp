...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
        ...
        <div class="main">
            ...
            <div class="container-fluid">
            	<div class="animated fadeIn">
                        ...
                        <div class="card-block">
                        	<form action="" class="form-horizontal ">
                        		<div class="form-group row">
	                                ...
	                                <div class="col-md-9">
	                                    <p class="form-control-static"><c:out value="${caso.casa.codigoCHF}"/></p>
	                                </div>
	                            </div>
                            </form>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-block">
                        	<spring:url value="/chf/editarcaso/participants/{codigoCaso}/" var="casoDataUrl">
                        		...
                        		<div class="row">
	                                <div class="col-sm-12">
	                                    <div class="form-group" hidden="true">
	                                        <label class="form-control-label" for="codigoCaso"><spring:message code="please.enter"/> <spring:message code="codigoCaso"/><span class="required">*</span></label>
	                                        <input type="text" readonly name="codigoCaso" id="codigoCaso" class="form-control" value="${caso.codigoCaso}"></input>
	                                    </div>
	                                </div>
	                            </div>
                                <div class="row">
	...
	<spring:url value="/resources/scripts/visitas/process-failvisit.js" var="visitScript" />
	...
	<spring:url value="/chf/editarcaso/saveCasoFailVisit" var="saveCasoFailVisitUrl"/>
	<c:set var="processSuccess"><spring:message code="process.success" /></c:set>
	<script>
	jQuery(document).ready(function() {			
		var parametros = {saveCasoFailVisitUrl: "${saveCasoFailVisitUrl}",
