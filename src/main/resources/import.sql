...
INSERT INTO `estudios_ics`.`estudios` (`CODIGO`, `ESTADO`, `PASIVO`, `NOMBRE`) VALUES (3, '0', '0', 'Cohorte Pediátrica Dengue');
INSERT INTO `estudios_ics`.`estudios` (`CODIGO`, `ESTADO`, `PASIVO`, `NOMBRE`) VALUES (4, '0', '0', 'Cohorte Pediátrica Influenza');
...
INSERT INTO `mensajes` (`messageKey`, `catKey`, `catRoot`, `en`, `isCat`, `orden`, `catPasive`, `es`) VALUES ('CENTRO_EST_209', '209', 'CENTRO_EST', NULL, '0', 37, '0', 'Centro Infantil CDI Niño De Jesús');
...
INSERT INTO `mensajes` (`messageKey`, `catKey`, `catRoot`, `en`, `isCat`, `orden`, `catPasive`, `es`) VALUES ('CAT_OPER_TEL', NULL, NULL, NULL, '1', 0, '0', 'Catalogo tipos de telefono');
