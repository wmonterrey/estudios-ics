...
INSERT INTO `mensajes` (`messageKey`, `catKey`, `catRoot`, `en`, `isCat`, `orden`, `catPasive`, `es`) VALUES ('CHF_CAT_RAZON_NO_MX_RESP_04', '4', 'CHF_CAT_RAZON_NO_MX_RESP', NULL, '0', 2, '0', 'Padre/niño no aceptó tomar muestra');
