...
@Embeddable
public class ConsentimientoChikId implements Serializable {
	/**
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ConsentimientoChikId))
			return false;
		ConsentimientoChikId castOther = (ConsentimientoChikId) other;
