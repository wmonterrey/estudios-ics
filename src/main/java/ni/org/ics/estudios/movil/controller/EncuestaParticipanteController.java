...
import ni.org.ics.estudios.domain.encuestas.EncuestaParticipante;
import ni.org.ics.estudios.service.EncuestaParticipanteService;
...
public class EncuestaParticipanteController {
    ...
    public @ResponseBody
    List<EncuestaParticipante> getEncuestasParticipante(@PathVariable String username) {
